...
SetPID1(3000,2000,4000)
SetPID2(3000,2000,4000)
SetPID3(3000,2000,4000)
...
while True:
    ...
    ReadAng2 = ReadAng[1]
    ReadAng3 = ReadAng[2]
    print("Read Ang1: %f" %ReadAng1)
    print("Read Ang2: %f" %ReadAng2)
    print("Read Ang3: %f" %ReadAng3)
    print(" ")
    XYZ = DeltaFWD(ReadAng1,ReadAng2,ReadAng3)
    print(" ")
    X = XYZ[0]
    Y = XYZ[1]
    Z = XYZ[2]
    INVDEG = DeltaINV(X,Y,Z)
    print(" ")
