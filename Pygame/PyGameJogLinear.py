...
time.sleep(3)
print("Jog Linear is ready to move")
...
try:
    while True:
        des_attitude = get()
        Xcom = rc_map(des_attitude[1], 1,-1, minX, maxX)
        Ycom = rc_map(des_attitude[2],-1, 1, minY, maxY)
        Zcom = rc_map(des_attitude[0],-1, 1, minZ, maxZ)
