...
set_A_PRFL = 50      # between 0 ~ set_A_limit      [214.577 rev/min^2]
...
time.sleep(3)
print("Jog Joint is ready to move")
...
try:
    while True:
        des_attitude = get()
        motor1 = rc_map(des_attitude[1], 1,-1, minJoint, maxJoint)
        motor2 = rc_map(des_attitude[2],-1, 1, minJoint, maxJoint)
        motor3 = rc_map(des_attitude[3],-1, 1, minJoint, maxJoint)
